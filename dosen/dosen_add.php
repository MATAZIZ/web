...
dosen(nip,nama,alamat,jenis_kelamin,email,telepon)
VALUES('$nip','$nama','$alamat','$jk','$email','$telepon')");
 
    header("Location:?page=dosen-show");
}
?>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="?page=dosen-add" class="form-horizontal">
