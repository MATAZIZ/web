    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                $query = mysqli_query($con, "SELECT * FROM user LIMIT $mulai, $limit") or
die();
                ?>
                <thead>
                    <tr>
...
. "%'");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="?page=user-edit&id=<?php echo
$data['id']; ?>">Edit</a>
                                <a class="btn btn-sm btn-danger" href="../user/user_delete.php?id=<?php echo
$data['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php
                        $no++;
            ...
            <ul class="pagination justify-content-end">
                ...
                $jumlah_page;
                 if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=usershow&halaman=1">First</a></li>';
...
href="?page=user-show&halaman=' . $i . '">' . $i . '</a></li>';
                 }
