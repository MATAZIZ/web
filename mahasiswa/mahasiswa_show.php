<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="../mahasiswa/mahasiswa_print.php" target="_blank" class="btn btn-success mb2">Cetak Data</a>
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                $query = mysqli_query($con, "SELECT * FROM mahasiswa LIMIT $mulai, $limit") or
die();
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="?page=mahasiswa-edit&id=<?php echo
   $data['id']; ?>">Edit</a>
                                <a class="btn btn-sm btn-danger"
   href="../mahasiswa/mahasiswa_delete.php?id=<?php echo $data['id']; ?>" onclick="return
...
$jumlah_page;
                ...
                if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=mahasiswashow&halaman=1">First</a></li>';
                    echo '<li class="page-item"><a class="page-link" href="?page=mahasiswa-show&halaman='
...
href="?page=mahasiswa-show&halaman=' . $i . '">' . $i . '</a></li>';
                }
